...
from dataset import MultiIterableDataSet, LinearDynamicalDatasetNb
...
if __name__ == '__main__':
    ...
    mdlargs_C = {"strictly_proper":True, "mag_range": (0.5, 0.97), "phase_range": (0, math.pi)}

    # Create data loader
    train_ds_A = LinearDynamicalDatasetNb(nx=cfg.nx, nu=cfg.nu, ny=cfg.ny, seq_len=cfg.seq_len_ctx+cfg.seq_len_new, **mdlargs_A)
    train_ds_B = LinearDynamicalDatasetNb(nx=cfg.nx, nu=cfg.nu, ny=cfg.ny, seq_len=cfg.seq_len_ctx+cfg.seq_len_new, **mdlargs_B)
    train_ds = MultiIterableDataSet((train_ds_A, train_ds_B))
    ...
    val_ds = LinearDynamicalDatasetNb(nx=cfg.nx, nu=cfg.nu, ny=cfg.ny, seq_len=cfg.seq_len_ctx+cfg.seq_len_new, **mdlargs_C)
