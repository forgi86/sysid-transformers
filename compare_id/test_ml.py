...
if __name__ == "__main__":
    ...
    estimator = estimators.FeedForwardStateEstimator(n_u=1, n_y=1, n_x=n_x,
    ...
    lr = 1e-3
    num_iter = 1#10_000  # ADAM iterations 20000
    ...
    #%%
    x0 = torch.zeros(1, n_x, device=u_full.device, dtype=u_full.dtype)
    with torch.no_grad():
        y_sim_full = model(x0, u_full)
